...
from blueprints.blueprint2.namespace1.services.get_service import get_service
from blueprints.blueprint2.namespace1.services.post_service import post_service
